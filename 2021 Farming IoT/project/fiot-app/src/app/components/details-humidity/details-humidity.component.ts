...
@Component({
  selector: 'app-details-humidity',
  templateUrl: './details-humidity.component.html',
  styleUrls: ['./details-humidity.component.css']
})
export class DetailsHumidityComponent implements OnInit {
