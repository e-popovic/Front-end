...
@Component({
  selector: 'app-details-soil-temp',
  templateUrl: './details-soil-temp.component.html',
  styleUrls: ['./details-soil-temp.component.css']
})
export class DetailsSoilTempComponent implements OnInit {
